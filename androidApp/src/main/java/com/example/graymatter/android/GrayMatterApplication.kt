...
import com.example.graymatter.feature.settings.settingsModule
...
class GrayMatterApplication : Application(), Configuration.Provider {
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            modules(androidAppModule, sharedModule, androidViewModelModule, graphModule, fileViewerModule, settingsModule)
        }
