...
object ExportService {
    ...
    fun exportOpinion(opinion: Opinion, resourceTitle: String? = null): String {
        val sb = StringBuilder()
        sb.append("# Knowledge Reflection\n\n")
        
        if (resourceTitle != null) {
            sb.append("**From:** $resourceTitle\n\n")
        }
        
        val dateStr = "Recorded on Reflection" // Common module might not have SimpleDateFormat
        sb.append("*$dateStr*\n\n")
        
        val pageInfo = if (opinion.pageNumber != null) " (Page ${opinion.pageNumber + 1})" else ""
        sb.append("## Reflection$pageInfo\n")
        
        if (opinion.text.startsWith("> ") || opinion.text.startsWith("[INDEX:")) {
            val cleanText = opinion.text
